...
PG_KEYWORD("pool", POOL, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("remainder", REMAINDER, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("size", SIZE, UNRESERVED_KEYWORD, BARE_LABEL)
