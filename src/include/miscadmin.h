...
#ifndef FRONTEND
#include "storage/interrupt.h" /* for IsInterruptPending(), INTERRUPT_* */
#endif
...
#define INTERRUPTS_PENDING_CONDITION(mask) \
	(unlikely(IsInterruptPending(mask)))
#else
#define INTERRUPTS_PENDING_CONDITION(mask) \
...
extern PGDLLIMPORT internal_guc int data_directory_mode;
...
extern PGDLLIMPORT session_guc bool IgnoreSystemIndexes;
