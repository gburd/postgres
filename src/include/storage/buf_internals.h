...
extern IOContext IOContextForStrategy(BufferAccessIntent intent);
extern BufferDesc *StrategyGetBuffer(BufferAccessIntent intent,
									 uint64 *buf_state, bool *from_ring);
extern bool StrategyRejectBuffer(BufferAccessIntent intent,
