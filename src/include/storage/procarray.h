...
extern bool SignalRecoveryConflict(PGPROC *proc, pid_t pid, InterruptType reason);
extern bool SignalRecoveryConflictWithVirtualXID(VirtualTransactionId vxid, InterruptType reason);
extern void SignalRecoveryConflictWithDatabase(Oid databaseid, InterruptType reason);
