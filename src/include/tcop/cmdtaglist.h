...
PG_CMDTAG(CMDTAG_ALTER_BUFFER_POOL, "ALTER BUFFER POOL", true, false, false)
...
PG_CMDTAG(CMDTAG_CREATE_BUFFER_POOL, "CREATE BUFFER POOL", true, false, false)
...
PG_CMDTAG(CMDTAG_DROP_BUFFER_POOL, "DROP BUFFER POOL", true, false, false)
