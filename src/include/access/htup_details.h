...
#define HEAP_INDEXED_UPDATED	0x0800	/* HOT tuple that also modified indexed
										 * attributes; accompanied by a tombstone
										 * line pointer on the same page.  When
										 * set on a tuple with natts==0 marks the
										 * tombstone itself.  See hot_indexed.h. */
