...
#define FLUX_UNDO_DELTA_UPDATE		0x0004	/* byte-diff before-image: the
												 * trailing bytes are a RelUndoDiffRecord
												 * splice, not a full old tuple; reverse-
												 * applied against the current on-page
												 * bytes (RelUndoApplyDiffReverse /
												 * FluxApplyDiffReverse). */
