...
/*
 * FileOps{DoPendingOps,PostPrepare,AtSubCommit,AtSubAbort}_hook: mirror the
 ...
 * operations (e.g. FILEOPS) needs the SAME commit/abort-sequencing position
 * as smgr's own pending-deletes housekeeping -- e.g.
 * FileOpsDoPendingOps_hook(true) is placed immediately after
 ...
 */
extern void (*FileOpsDoPendingOps_hook) (bool isCommit);
extern void (*FileOpsPostPrepare_hook) (void);
extern void (*FileOpsAtSubCommit_hook) (void);
extern void (*FileOpsAtSubAbort_hook) (void);
