...
typedef struct TableAmRoutine
{
	 ...
	 *
	 * This is called during TOAST table creation when the parent table does
	 * not specify an explicit overflow_buffer_pool reloption.  The AM can
	 * provide an algorithm-specific default (e.g. a write-optimized strategy
	 * for heap TOAST data).
	 *
