...
extern PGDLLIMPORT bool recno_enable_serializable;
...
typedef struct RecnoMvccData
{
	...
	uint64		serializable_horizon;
	bool		anti_deps_tracking;
} RecnoMvccData;
...
extern void RecnoRecordReadConflict(uint64 writer_start_ts, uint64 writer_commit_ts, bool writer_committed);
extern void RecnoRecordWriteConflict(uint64 reader_start_ts, uint64 reader_commit_ts, bool reader_committed, bool reader_is_read_only);
