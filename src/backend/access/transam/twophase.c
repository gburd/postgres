...
FinishPreparedTransaction(const char *gid, bool isCommit)
{
	...
	else
	{
		...
		/*
		 * ROLLBACK PREPARED: hand any cluster-wide UNDO chain (FILEOPS,
		 * nbtree/hash) to the same async revert machinery an ordinary
		 * large-transaction abort uses.  The permanent-level chain-head LSN
