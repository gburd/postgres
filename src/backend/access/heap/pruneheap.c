...
heap_page_prune_opt(Relation relation, Buffer buffer, Size tuple_len)
{
	 ...
	 *
	 * If a specific tuple length is provided, we also consider pruning if
	 * the current free space plus potential space from pruning could accommodate
	...
	/*
	 * Check if we should prune based on normal criteria or tuple-specific needs
	 */
