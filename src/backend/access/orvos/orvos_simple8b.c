/*
 * orvos_simple8b.c
 *		Simple-8b encoding wrapper for orvos
 *
 ...
 * re-exports those functions via the orvos_simple8b.h header.
 *
 * Portions Copyright (c) 1996-2026, PostgreSQL Global Development Group
 * Portions Copyright (c) 1994, Regents of the University of California
 *
 * IDENTIFICATION
 *	  src/backend/access/orvos/orvos_simple8b.c
 */
#include "postgres.h"
 ...
 * and declared in lib/simple8b.h.  The orvos_simple8b.h header includes
