/*
 * orvos_simple8b.c
 *		Simple-8b encoding for orvos
 *
 * FIXME: This is copy-pasted from src/backend/lib/integerset.c. Some of
 * the things we do here are not relevant for the use in orvos, or could
 ...
 *
 * IDENTIFICATION
 *	  src/backend/access/orvos/orvos_simple8b.h
 */
#include "postgres.h"
					  ...
					  uint64 *dst, int num_integers)
{
	 ...
	 * function is actually used, i.e. to encode TIDs, and the number of
	 * integers comes from the item header.
	 */
