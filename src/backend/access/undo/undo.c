...
UndoShmemRequest_internal(void *arg)
{
	 ...
	 * during the request_fn phase (before BackgroundWorkerShmemInit runs in
	 * the init_fn phase), because RegisterBackgroundWorker() cannot be called
	 * after BackgroundWorkerShmemInit().
	 *
