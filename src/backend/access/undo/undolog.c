...
{
	/*
	 * This should not be called in the UNDO-in-WAL architecture. Space
	 * allocation is implicit via XLogInsert.
	 */
	ereport(ERROR,
...
{
	/*
	 * This should not be called in the UNDO-in-WAL architecture. UNDO data is
	 * written to WAL via XLogInsert.
	 */
	ereport(ERROR,
...
{
	/*
	 * This should not be called in the UNDO-in-WAL architecture. UNDO records
	 * are read from WAL via UndoReadBatchFromWAL().
	 */
	ereport(ERROR,
