						 ...
						 ObjectAddress *typaddress)
{
	...
	if (OidIsValid(toastrelid))
	{
		...
		reltoasterids = (Datum)(construct_array_builtin(&toasterids, 1, OIDOID));
		reltoastrelids = (Datum)(construct_array_builtin(&toastrelids, 1, OIDOID));
	}
