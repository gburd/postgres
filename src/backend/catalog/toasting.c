...
static void CheckAndCreateToastTable(Oid relOid, Datum reloptions,
									 ...
									 Relation old_heap);
static Oid	create_toast_table_generic(Relation rel, Oid toasterid, Oid toastOid, Oid toastIndexOid,
...
NewHeapCreateToastTable(Oid relOid, Datum reloptions, LOCKMODE lockmode,
						Relation old_heap)
{
	CheckAndCreateToastTable(relOid, reloptions, lockmode, false, old_heap);
}
						 ...
						 bool check, Relation old_heap)
{
	...
	else
	{
		...
		/*
		 * Create toaster data storage (heap table for generic toaster), once
		 * per table for each toaster.
		 */
...
/*
 * Helper function to modify pg_class tuple with new toast arrays
 */
HeapTuple
...
/*
 * Helper function to add a toaster to the class tuple
 */
static HeapTuple
...
/*
 * Register a toast table in pg_class and set up dependencies
 */
void
register_toast_table(Oid relid, Oid toasterid, Oid toastrelid)
{
	...
	/*
	 * While bootstrapping, pg_class tuple's toastrelid must have been already
	 * set
	 */
...
/*
 * Wrapper function for create_toast_table_generic
 */
bool
