						   ...
						   TupleTableSlot *new_tts)
{
	 ...
	 * tuple values is always correct and matches the heap's own classic-HOT
	 * determination (HeapDetermineColumnsInfo in upstream), which likewise
	 * compares every interesting column rather than consulting the target
	 * list.
	 *
