...
static PG_THREAD_LOCAL PG_GLOBAL_BACKEND const void **dispatch_table = NULL;

/* jump target -> opcode lookup table */
static PG_THREAD_LOCAL PG_GLOBAL_BACKEND ExprEvalOpLookup reverse_dispatch_table[EEOP_LAST];
