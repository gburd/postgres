 ...
 * GUC parameters
 */
sighup_guc bool		autovacuum_start_daemon = false;
sighup_guc int			autovacuum_worker_slots;
sighup_guc int			autovacuum_max_workers;
sighup_guc int			autovacuum_work_mem = -1;
sighup_guc int			autovacuum_naptime;
sighup_guc int			autovacuum_vac_thresh;
sighup_guc int			autovacuum_vac_max_thresh;
sighup_guc double		autovacuum_vac_scale;
sighup_guc int			autovacuum_vac_ins_thresh;
sighup_guc double		autovacuum_vac_ins_scale;
sighup_guc int			autovacuum_anl_thresh;
sighup_guc double		autovacuum_anl_scale;
sighup_guc int			autovacuum_freeze_max_age;
sighup_guc int			autovacuum_multixact_freeze_max_age;
...
sighup_guc double		autovacuum_vac_cost_delay;
sighup_guc int			autovacuum_vac_cost_limit;

sighup_guc int			Log_autovacuum_min_duration = 600000;
