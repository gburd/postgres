...
RelationParseRelOptions(Relation relation, HeapTuple tuple)
{
	 ...
	 *
	 * Only heap-like relations use StdRdOptions containing buffer_pool_offset.
	 * Index relations use AM-specific option structs (BTOptions, etc.) that
	 * do not contain this field -- casting them to StdRdOptions would read
