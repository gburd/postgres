...
FileopsUndoRmgrInit(void)
{
	 ...
	 */
	FileOpsDoPendingOps_hook = FileOpsDoPendingOps;
	FileOpsPostPrepare_hook = PostPrepare_FileOps;
	FileOpsAtSubCommit_hook = AtSubCommit_FileOps;
	FileOpsAtSubAbort_hook = AtSubAbort_FileOps;
}
