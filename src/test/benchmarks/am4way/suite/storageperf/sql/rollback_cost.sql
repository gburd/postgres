...
-- With recno_instant_abort_threshold = 0, ATM instant abort is used
-- for all transactions. With the default threshold, small transactions
-- use synchronous UNDO and large ones use ATM.
--
...
RESET recno_instant_abort_threshold;
SHOW recno_instant_abort_threshold;
...
SET recno_instant_abort_threshold = 0;
