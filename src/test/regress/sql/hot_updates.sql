...
--
-- Note: HOT-indexed (Selective Index Update) is always on in this build;
-- UPDATEs that modify a non-summarizing indexed column may still be
-- performed as heap-only tuples provided a tombstone fits on the same
-- page.  The observed HOT counts include both classic HOT updates and
-- HOT-indexed updates.
