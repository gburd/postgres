...
-- ---------------------------------------------------------------------------
-- 9. GIN amcomparedatums: same extracted keys = HOT
-- ---------------------------------------------------------------------------
...
-- Reorder tags: GIN extracts the same key set.  amcomparedatums lets
-- the HOT decision treat this as a no-op for the index: HOT.
