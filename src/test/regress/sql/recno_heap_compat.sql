...
-- Drain this backend's pending DML deltas into shared stats before reading
-- pg_stat_user_tables; without the flush the counts race the ~1s pgstat
-- reporting interval and read back as zero.
