...
modify_rel_block(PG_FUNCTION_ARGS)
{
	...
	buf = ReadBufferExtended(rel, MAIN_FORKNUM, blkno,
							 RBM_ZERO_ON_ERROR, BUF_INTENT_NORMAL);
...
create_toy_buffer(Relation rel, BlockNumber blkno)
{
	...
	buf = ReadBufferExtended(rel, MAIN_FORKNUM, blkno, RBM_ZERO_AND_LOCK, BUF_INTENT_NORMAL);
...
read_buffers(PG_FUNCTION_ARGS)
{
	...
	while (nblocks_done < nblocks)
	{
		...
		operation->intent = BUF_INTENT_NORMAL;
