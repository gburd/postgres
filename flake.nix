{
  ...
  inputs = {
    ...
    libumem = {
      url = "git+https://codeberg.org/gregburd/libumem";
      flake = true;
    };
  };
  ...
  outputs = {
    ...
    flake-utils.lib.eachDefaultSystem (
      system: let
        ...
        libumemPkgs = libumem.packages.${system};

        shellConfig = import ./shell.nix {inherit pkgs pkgs-unstable system libumemPkgs;};
      in {
