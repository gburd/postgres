  ...
  getPostgreSQLDeps = muslLibs:
    with pkgs;
      [
        ...
        # Parser/lexer generator -- Lime replaces bison+flex on this
        # branch.  Runtime-extensible LALR(1) generator with optional
        # LLVM JIT and SIMD tokenization.  See ../../lime for sources
        # and docs/MIGRATION_FROM_BISON.md for the porting guide.
        limePkg
