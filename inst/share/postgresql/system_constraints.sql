...
ALTER TABLE pg_propgraph_element ADD PRIMARY KEY USING INDEX pg_propgraph_element_oid_index;

ALTER TABLE pg_propgraph_element ADD UNIQUE USING INDEX pg_propgraph_element_alias_index;

ALTER TABLE pg_propgraph_element_label ADD PRIMARY KEY USING INDEX pg_propgraph_element_label_oid_index;

ALTER TABLE pg_propgraph_element_label ADD UNIQUE USING INDEX pg_propgraph_element_label_element_label_index;

ALTER TABLE pg_propgraph_label ADD PRIMARY KEY USING INDEX pg_propgraph_label_oid_index;

ALTER TABLE pg_propgraph_label ADD UNIQUE USING INDEX pg_propgraph_label_graph_name_index;

ALTER TABLE pg_propgraph_label_property ADD PRIMARY KEY USING INDEX pg_propgraph_label_property_oid_index;

ALTER TABLE pg_propgraph_label_property ADD UNIQUE USING INDEX pg_propgraph_label_property_label_prop_index;

ALTER TABLE pg_propgraph_property ADD PRIMARY KEY USING INDEX pg_propgraph_property_oid_index;

ALTER TABLE pg_propgraph_property ADD UNIQUE USING INDEX pg_propgraph_property_name_index;
