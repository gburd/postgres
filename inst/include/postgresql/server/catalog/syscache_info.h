...
static const struct cachedesc cacheinfo[] = {
	...
	[PROPGRAPHELALIAS] = {
		...
		KEY(Anum_pg_propgraph_element_pgepgid, Anum_pg_propgraph_element_pgealias),
		128
	},
	[PROPGRAPHELEMENTLABELELEMENTLABEL] = {
		PropgraphElementLabelRelationId,
		PropgraphElementLabelElementLabelIndexId,
		KEY(Anum_pg_propgraph_element_label_pgelelid, Anum_pg_propgraph_element_label_pgellabelid),
		128
	},
	[PROPGRAPHELOID] = {
		PropgraphElementRelationId,
	...
	[PROPGRAPHLABELNAME] = {
		...
		KEY(Anum_pg_propgraph_label_pglpgid, Anum_pg_propgraph_label_pgllabel),
		128
	},
	[PROPGRAPHLABELOID] = {
		PropgraphLabelRelationId,
		PropgraphLabelObjectIndexId,
		KEY(Anum_pg_propgraph_label_oid),
		128
	},
	[PROPGRAPHLABELPROP] = {
		PropgraphLabelPropertyRelationId,
		PropgraphLabelPropertyLabelPropIndexId,
		KEY(Anum_pg_propgraph_label_property_plpellabelid, Anum_pg_propgraph_label_property_plppropid),
		128
	},
	[PROPGRAPHPROPNAME] = {
		PropgraphPropertyRelationId,
		PropgraphPropertyNameIndexId,
		KEY(Anum_pg_propgraph_property_pgppgid, Anum_pg_propgraph_property_pgpname),
		128
	},
	[PROPGRAPHPROPOID] = {
		PropgraphPropertyRelationId,
		PropgraphPropertyObjectIndexId,
		KEY(Anum_pg_propgraph_property_oid),
		128
	},
	[PUBLICATIONNAME] = {
