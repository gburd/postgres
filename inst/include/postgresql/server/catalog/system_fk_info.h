...
static const SysFKRelationship sys_fk_relationships[] = {
	...
	{ /* pg_propgraph_element */ 6466, /* pg_class */ 1259, "{pgepgid}", "{oid}", false, false},
	{ /* pg_propgraph_element */ 6466, /* pg_class */ 1259, "{pgerelid}", "{oid}", false, false},
	{ /* pg_propgraph_element */ 6466, /* pg_propgraph_element */ 6466, "{pgesrcvertexid}", "{oid}", false, true},
	{ /* pg_propgraph_element */ 6466, /* pg_propgraph_element */ 6466, "{pgedestvertexid}", "{oid}", false, true},
	{ /* pg_propgraph_element_label */ 6472, /* pg_propgraph_label */ 6470, "{pgellabelid}", "{oid}", false, false},
	{ /* pg_propgraph_element_label */ 6472, /* pg_propgraph_element */ 6466, "{pgelelid}", "{oid}", false, false},
	{ /* pg_propgraph_label */ 6470, /* pg_class */ 1259, "{pglpgid}", "{oid}", false, false},
	{ /* pg_propgraph_label_property */ 6482, /* pg_propgraph_property */ 6473, "{plppropid}", "{oid}", false, false},
	{ /* pg_propgraph_label_property */ 6482, /* pg_propgraph_element_label */ 6472, "{plpellabelid}", "{oid}", false, false},
	{ /* pg_propgraph_property */ 6473, /* pg_class */ 1259, "{pgppgid}", "{oid}", false, false},
	{ /* pg_propgraph_property */ 6473, /* pg_type */ 1247, "{pgptypid}", "{oid}", false, true},
	{ /* pg_propgraph_property */ 6473, /* pg_collation */ 3456, "{pgpcollation}", "{oid}", false, true},
};
