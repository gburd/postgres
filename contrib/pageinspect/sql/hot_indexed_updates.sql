...
-- 14 (ItemPointerRecheckHintFlag, storage/itemptr.h), set only on a
...
-- index, a HOT-indexed fresh entry stores that TID with the recheck-hint
...
-- (ItemPointerRecheckHintFlag) set on its heap TID.  When many such entries
